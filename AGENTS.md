...
- Любой новый обходной путь, допущение или частичный фикс ночью сразу записывать в `TASKS.md` как follow-up.
- После каждого подблока ночью обязательно:
  - обновить статус в `TASKS_NIGHT.md`
  - обновить `TASKS.md`, если изменился backlog или появился техдолг
