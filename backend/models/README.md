...
```bash
export MODEL_REGISTRY_CONFIG_PATH="/mnt/d/llm-tools-platform/backend/config/models.yaml"
...
- [Qwen/Qwen2.5-14B-Instruct-GGUF](https://huggingface.co/Qwen/Qwen2.5-14B-Instruct-GGUF)
