                ...
                [
                    self._preset(
                        ...
                        "model_source_mode",
                        {
                            ...
                            "MODEL_PATH_LLM": "/app/backend/models/gguf/qwen-14b/Qwen3-14B.Q4_K_M.gguf",
                ...
                [
                    {
                        ...
                        "fields": [
                            self._field(bundle_env, "MODEL_PATH_LLM", "LLM model path", "LLM model path", "deploy/offline_bundle/env.bundle", suggested=env_value(bundle_env, "MODEL_PATH_LLM", default="/app/backend/models/gguf/qwen-14b/Qwen3-14B.Q4_K_M.gguf"), recommended_reason="Container-side путь к основному LLM artifact.", recommended_reason_en="Container-side path to the main LLM artifact.", path_policy="bundle_internal_path", path_example="/app/backend/models/gguf/qwen-14b/Qwen3-14B.Q4_K_M.gguf"),
