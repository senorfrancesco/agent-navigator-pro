                ...
                [
                    {
                        ...
                        "fields": [
                            ...
                            self._field(
                                ...
                                "Open WebUI secret key",
                                "backend/.env",
                                suggested=env_value(backend_env, "WEBUI_SECRET_KEY", default="agent-navigator-openwebui-dev-secret-change-me"),
                            ...
                            self._field(
                                ...
                                "Open WebUI admin name",
                                "backend/.env",
                                suggested=env_value(backend_env, "WEBUI_ADMIN_NAME", default="Agent Navigator Admin"),
