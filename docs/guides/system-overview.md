...
Общее руководство по архитектуре, компонентам и рабочему процессу llm-tools-platform.

---

## Что это такое

**llm-tools-platform** — агентная система для анализа юридических документов и технических спецификаций. Принимает PDF/DOCX файлы, понимает запрос пользователя и запускает нужный pipeline:
...
└──────────────────────┬───────────────────────────────┘
                       ...
                       ▼
┌──────────────────────────────────────────────────────┐
│  Backend (хост, tmux-сессия llm-tools-platform)         │
│                                                      │
│  ┌─────────────────────────────────────────────┐    │
